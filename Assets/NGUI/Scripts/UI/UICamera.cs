...
public class UICamera : MonoBehaviour
{
	...
	public class MouseOrTouch
	{
		...
		}								// Total time a touch took place
		public float startTime;			// Time a touch started
	...
	public static Dictionary<int, MouseOrTouch> mTouches = new Dictionary<int, MouseOrTouch>();
